    ...
    <div class="container-card">
      <div class="card" v-for="eve in evento" :key="eve._id">
        ...
        <div class="contenido-card">
          ...
          <a @click="$refs.eventModal.openUpdate(eve)">Editar</a>
          <a @click="remove(eve._id)">Eliminar</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container-card">
      <div class="card" v-for="privateEve in eventoprivado" :key="privateEve._id">
        ...
        <div class="contenido-card">
          ...
          <a @click="$refs.eventModal.openUpdate(privateEve)">Editar</a>
          <a @click="remove(privateEve._id)">Eliminar</a>
        </div>
      </div>
    </div>
  </div>
